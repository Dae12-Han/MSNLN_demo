...
class MultisourceProjection(nn.Module):
    ...
    def forward(self,x):
        ...
        err1 = self.encoder1(up_map1-up_map2)
        final_map1 = up_map2 + err1
        
        err = self.encoder2(final_map1-down_map)
...
class MSNLN_631_2(nn.Module):
    def __init__(self, args, conv=common.default_conv):
        super(MSNLN_631_2, self).__init__()
