...
class MultisourceProjection(nn.Module):
    ...
    def forward(self,x):
        ...
        err1 = self.encoder(up_map1-up_map2)
        final_map1 = up_map2 + err1
        
        err = self.encoder(final_map1-down_map)
...
class MSNLN_931_1(nn.Module):
    def __init__(self, args, conv=common.default_conv):
        super(MSNLN_931_1, self).__init__()
