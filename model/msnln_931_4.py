...
class MultisourceProjection(nn.Module):
    ...
    def forward(self,x):
        ...
        err1 = self.encoder(up_map1-down_map)
        final_map1 = down_map + err1

        err2 = self.encoder(up_map2-down_map)
        final_map2 = down_map + err2 
        
        err = self.encoder(final_map2-final_map1)
...
class MSNLN_931_4(nn.Module):
    def __init__(self, args, conv=common.default_conv):
        super(MSNLN_931_4, self).__init__()
